...
<<<<<<< HEAD
                            <template x-for="(opt, idx) in form.sections[selectedSection].fields[selectedField].options" :key="idx">
                                <div class="input-group mb-2">
                                    ...
                                    <select class="form-select" x-model="form.sections[selectedSection].fields[selectedField].options[idx].redirect">
                                        <option value="">-- Ir a sección --</option>
                                        <template x-for="(section, i) in form.sections" :key="i">
                                            <option :value="section.name" x-text="section.name"></option>
                                        </template>
                                    </select>
                                    <button class="btn btn-outline-danger" @click="form.sections[selectedSection].fields[selectedField].options.splice(idx, 1)">×</button>
                                </div>
                            </template>
...
<<<<<<< HEAD
                            ...
                            <select class="form-select" multiple x-model="form.sections[selectedSection].fields[selectedField].accept">
                                ...
                                <option value="image/jpg">Imagen (.jpg)</option>
