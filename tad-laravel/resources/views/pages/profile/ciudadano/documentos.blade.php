...
<div class="card shadow rounded-4 px-4 py-5 mb-4">
  <div class="row align-items-center">
    ...
    <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center mb-3">
      <h5 class="mb-0 fw-semibold">Mis documentos</h5>
    </div>

    <form method="GET" action="" class="mb-4">
      <div class="input-group">
        <input type="text" name="buscar" class="form-control" placeholder="Buscar por folio" value="{{ request('buscar') }}">
    ...
    <ul class="nav nav-tabs custom-tabs justify-content-center flex-wrap mb-4" id="interesTabs" role="tablist">
      <li class="nav-item" role="presentation">
        <a class="nav-link active" id="documentos-tab" data-bs-toggle="tab" href="#documentosTab" type="button" role="tab">Mis documentos</a>
      </li>
      <li class="nav-item" role="presentation">
        <a class="nav-link" id="register-tab" data-bs-toggle="tab" href="#registerTab" type="button" role="tab">Mis tramites aprobados</a>
      </li>
      <li class="nav-item" role="presentation">
        <a class="nav-link" id="register-tab" data-bs-toggle="tab" href="#registerTab" type="button" role="tab">Mis tramites desistidos</a>
      </li>
      <li class="nav-item" role="presentation">
        <a class="nav-link" id="register-tab" data-bs-toggle="tab" href="#registerTab" type="button" role="tab">Mis acuses</a>
      </li>
    </ul>
    <div class="tab-pane fade show active" id="documentosTab" role="tabpanel">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6 mb-2">
              <p class="mb-1"><strong>Tipo:</strong> {{ $documento['Tipo'] }}</p>
              <p class="mb-1"><strong>Fecha de creacion:</strong> {{ $documento['Fecha de creación'] }}</p>
            </div>
