    ...
    <div class="card mb-4 shadow rounded-4 border-0">
      <div class="card-body">
        ...
        <div class="d-flex align-items-center mb-3">
          ...
          <h5 class="card-title mb-0">{{ $pago['Trámite'] }}</h5>
        </div>

        <div class="row">
          <div class="col-md-4 mb-2">
            <p class="mb-1"><strong>Número de folio:</strong> {{ $pago['Número de folio'] }}</p>
            <p class="mb-1"><strong>Folio de trámite:</strong> {{ $pago['Folio de trámite'] }}</p>
            <p class="mb-1"><strong>Fecha:</strong> {{ \Carbon\Carbon::parse($pago['Fecha'])->format('d/m/Y H:i:s') }}</p>
          </div>

          <div class="col-md-4 mb-2">
            <p class="mb-1"><strong>Número de transacción:</strong> {{ $pago['Número de transacción'] }}</p>
